                      ...
                      <div>
                        <div class="card-body">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6">
                              <div class="mb-3 d-flex flex-column">
                                ...
                                <input type="tel" id="phone" name="phone" class="form-control" oninput="this.value = this.value.replace(/\D/g, '')" placeholder="Mobile Number">
                              </div>
                            </div>
                            <!--/span-->
                          </div>
                            ...
                            <div class="col-md-6">
                              <div class="mb-3 d-flex gap-4" >
                                ...
                                <div class="form-check py-1">
                                  <input type="radio" name="isnri" value="1" id="nriYes" name="nri" class="form-check-input">
                                  <label class="form-check-label" for="nriYes">Yes</label>
                                </div>
                                <div class="form-check py-1">
                                  <input type="radio" name="isnri" value="0" id="nriNo" name="nri" class="form-check-input">
                          ...
                          <div class="form-check">
                            <input type="checkbox" name="agreement" class="form-check-input" id="agree" value="1">
                            <label class="form-check-label" for="sf6">I agree to receive information regarding about my Enquiry of admission by submitting it on St. Aloysius (Deemed to be University) via Email/ SMS/ Whatsapp</label>
                        </div>
...
@endif
    ...
    async function loadCountries() {
        const data = await fetchData("https://countriesnow.space/api/v0.1/countries");
        if (data && data.data) {
    ...
    // Fetch States When Country is India
    async function loadStates() {
        ...
        stateSelect.style.display = "block"; // Show state dropdown if India is selected

        const data = await fetchData("https://countriesnow.space/api/v0.1/countries/states", {
            method: "POST",
