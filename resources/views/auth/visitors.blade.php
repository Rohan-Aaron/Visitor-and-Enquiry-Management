        ...
        <div class="card-body">
            ...
            <div class="d-flex flex-wrap flex-grow-1 justify-content-between my-2">
                <form method="GET" action="{{ route('visitors.index') }}" class="d-flex  w-50 mb-2">
                    <input type="text" name="search" value="{{ request('search') }}" id="searchInput" class="form-control"
                ...
                <button type="button" class="btn btn-success mb-2" data-bs-toggle="modal"
                    data-bs-target="#addVisitorModal">+ Add New</button> --}}
            </div>
                        ...
                        <tbody>
                            ...
                            @foreach ($visitors as $index => $visitor)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('visitors.show', $visitor->visitor_id) }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control @error('Name') is-invalid @enderror"
                                        name="Name" id="name" placeholder="Enter Name here" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating mb-3">
                                    <input type="number" class="form-control @error('visit_count') is-invalid @enderror"
                                        name="visit_count" id="visit_count" value="1" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control @error('reason') is-invalid @enderror"
                                        name="reason" id="reason" placeholder="Enter Reason" required>
                            ...
                            <div class="col-md-12">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control @error('description') is-invalid @enderror"
                                        name="description" id="description" placeholder="Enter Description" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating mb-3">
                                    <input type="date" class="form-control @error('visit_date') is-invalid @enderror"
                                        name="visit_date" id="visit_date" required>
