        ...
        @endphp
                    ...
                    <div class="email_content">
                        <div class="email_inner_section">
                            <section>
                                <h4>Welcome to St. Aloysius (Deemed to be <span style="font-weight: bold;">University</span>)
                                </h4>
                                        ...
                                        <div class="card-body ">
                                            <table style="margin: 0px auto;">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <th>Reason</th>
                                                        <td>{{ $visit->category == 'other' ? ucwords( $visit->other_category) :  ucwords(str_replace('_', ' ', $visit->category)) }} }}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th>Description</th>
                                                    ...
                                                    <tr>
                                                        <th>Date</th>
                                                        <td>{{ \Carbon\Carbon::parse($visit->arrived_at)->format('d/ m/ Y') }}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th>Time</th>
                                                        <td>{{ \Carbon\Carbon::parse($visit->arrived_at)->format('H:i:s') }}
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                            <h3>SAU{{ \Carbon\Carbon::parse($visit->arrived_at)->format('y - m') }} :
                                                {{ $visitor->visitor_id }}</h3>
                                        </div>
